...
export const AnimatedProducts = ({
  ...
  return (
    <div className="mx-auto w-full max-w-max px-4 py-20 font-sans antialiased md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="bg-card flex flex-col justify-between rounded-xl border px-4 py-4 shadow-2xl lg:px-12">
          <motion.div
            key={active}
            initial={{
              y: 20,
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <p className="flex items-center gap-2 text-lg text-orange-400">
